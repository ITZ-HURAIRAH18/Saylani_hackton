              ...
              <>
                ...
                <div className="ml-4 pl-4 border-l border-white/20 flex items-center space-x-3">
                  <Link
                    ...
                    className="px-4 py-2 bg-yellow-400/90 hover:bg-yellow-400 text-indigo-900 rounded-lg transition-all duration-200 font-medium shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
                  >
                    Change Password
                  </Link>
